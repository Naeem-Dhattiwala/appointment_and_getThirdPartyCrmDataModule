...
class AppointmentActions extends \Magento\Ui\Component\Listing\Columns\Column
{
    ...
    const URL_PATH_DETAILS = 'iram_appointments/appointment/details';
    protected $urlBuilder;
    const URL_PATH_DELETE = 'iram_appointments/appointment/delete';
    const URL_PATH_EDIT = 'iram_appointments/appointment/edit';
