...
class CustomerFilter extends \Magento\Backend\Block\Template\Context implements \Magento\Framework\Option\ArrayInterface 
{
    ...
    public function toOptionArray()
    {
        ...
        foreach ($Appointmentdata as $key => $Appointmentvalue) {
            $Customer_id[$key] = [$Appointmentvalue->getCustomer_id()];
            $Collection = $this->customerFactory->create()->getCollection()
                        ->addFieldToFilter('entity_id', ['in'=>$Customer_id[$key]]);
